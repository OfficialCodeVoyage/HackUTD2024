...
const { createService } = require('./serviceFactory'); // Import the service factory
...
// Determine which service to use through dependency injection
...
app.ws('/connection', async (ws) => {
  try {
    ...
    // If using RagService, vectorize all data upon server start
